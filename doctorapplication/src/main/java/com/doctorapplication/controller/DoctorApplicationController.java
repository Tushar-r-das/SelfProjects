...
public class DoctorApplicationController {
   ...
   @PostMapping("/doctor-login")
    public List<DoctorEntity> login(@RequestParam("userid")String userId,@RequestParam("password")String password,HttpServletRequest request) {
	return doctorapplicationdao.login(userId, password);	
}
}