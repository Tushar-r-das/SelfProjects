...
public class PatientApplicationController {
	...
	private PatientApplicationDao patientapplicationdao;
		...
		public List<PatientEntity> login(@RequestParam("userid")String userId,@RequestParam("password")String password,HttpServletRequest request) {
			return patientapplicationdao.login(userId, password);	
	}
}